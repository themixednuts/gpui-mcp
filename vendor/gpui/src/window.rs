...
/// Result of dispatching one platform input event through a window.
#[derive(Clone, Debug, Default, PartialEq, Eq)]
pub struct DispatchEventResult {
    /// Whether the event continued propagating through registered listeners.
    pub propagate: bool,
    /// Whether a listener prevented GPUI's default behavior.
